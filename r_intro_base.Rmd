...
Base R has a famous family of functions that I like to call the "apply" family. `r lapply` applies a function to each element of the list.
```{r}
lapply(list1, mean) 

lapply(list1, function(x) sum(x^2)) 
```
